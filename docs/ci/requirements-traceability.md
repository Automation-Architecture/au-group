...
| **AC-4.2** | Tier identification 95%+ | partial | `ci-supabase` → `smoke_tier_classification.sql` | SQL smoke on `au_group_classify_company_tier` (synthetic fixtures); SYS-03 n8n + ZoomInfo 95% sampling still manual |
