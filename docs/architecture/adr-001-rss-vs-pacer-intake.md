...
- **SYS-02** orchestrates `document_intelligence` only; Schedule F belongs in **SYS-06** (detect) and **SYS-07** (approve/download). See [sys-02-orchestration.md](./sys-02-orchestration.md).
