# PACER API Reference — Authentication + Case Locator (PCL)

**Sources:**
- Authentication API: https://pacer.uscourts.gov/sites/default/files/files/PACER%20Authentication%20API-122021.pdf (Dec 2021)
...
## PACER Developer Resources Portal

## PACER Developer Resources Portal

Source: https://pacer.uscourts.gov/file-case/developer-resources

### Authentication API
- User Guide: https://pacer.uscourts.gov/help/pacer/pacer-authentication-api-user-guide
- Contact: developers@psc.uscourts.gov / (800) 676-6856

### Court CM/ECF Lookup Data Feed
- JSON: https://pacer.uscourts.gov/file-case/court-cmecf-lookup/data.json
- XML:  https://pacer.uscourts.gov/file-case/court-cmecf-lookup/data.xml
(Returns court IDs, CM/ECF base URLs, and court names — use to build courtId → CM/ECF URL mapping for document download)


---

# Part 1 — PACER Authentication API

*Verbatim extracted text from the official PACER Authentication API User Guide (Dec 2021)*
...
<!-- page 2 -->
Contents
PACER Authentication API ............................................................................................................................ 3
Authentication Examples ............................................................................................................................. 4
JSON Request ............................................................................................................................................ 5
XML Request ............................................................................................................................................. 5
cURL .................................................................................................................................................................... 6
Logout Examples ........................................................................................................................................... 7
...
cURL .................................................................................................................................................................... 8
Java Examples .................................................................................................................................................... 9
Common Error Message Examples .............................................................................................................. 11
2
...
account registration URL. The PACER authentication service accepts a valid PACER username and
password and returns an authentication token.
...
data, and searches are not billable. To access this environment, a QA PACER account is required.
This account is separate from any other PACER accounts and can only be used in the QA
environment. Register for this type of account at: https://qa-pacer.uscourts.gov. For a Production
account, register at https://pacer.uscourts.gov.
...
Method POST
Request Use the request header to specify the format of the request and the response.
headers The Content-type header indicates the format of the request and the Accept
...
the header of each request to court systems.2
NOTE: If you access legacy (CurrentGen) courts, the nextGenCSO
authentication token should also be set as a PacerSession cookie. Once
all courts have converted to NextGen, this will be deprecated.
If the optional client code information is included, the PacerClientCode cookie
should be set and passed in the header of each request to court systems.3
...
1 All filers must redact the following: Social Security or taxpayer identification numbers; dates of birth; names of minor
...
attachments.
2 Please see the PACER Case Locator (PCL) API for specifics on setting header values instead of cookies.
3 See note 2.
4
...
Method POST
Request Use the request header to specify the format of the request and the response.
headers TheContent-Type header indicates the format of the request, and the Accept
header indicates the format of the response.
For JSON formatting, use:
application/json
For XML formatting, use:
...
# Part 2 — PACER Case Locator (PCL) API

*Verbatim extracted text from the official PCL API User Guide (Dec 2022)*
...
Batch Searches ................................................................................................................................... 24
Batch Search Examples ........................................................................................................................ 29
Start a Batch Case Search - JSON ....................................................................................................... 29
Start Batch Case Search - XML ........................................................................................................... 30
Get Batch Job Status - JSON ............................................................................................................... 30
Get Batch Job Status - XML ................................................................................................................ 31
Get List of Batch Jobs – JSON ............................................................................................................ 32
Get List of Batch Jobs – XML .............................................................................................................. 33
Get Batch Job Results - JSON ............................................................................................................. 34
Get Batch Job Results - XML .............................................................................................................. 34
PCL Search API ............................................................................................................................................ 36
Setting the Headers ............................................................................................................................... 36
API Endpoints ............................................................................................................................................. 37
Basic Searches ....................................................................................................................................... 37
Batch Jobs .............................................................................................................................................. 37
Search Criteria—Data Definitions .............................................................................................................. 40
Case Searches – Searchable Fields ......................................................................................................... 40
Case Search – JSON Representation Case Search – XML Representation .................................. 43
2

<!-- page 3 -->
Party Searches – Searchable Fields ........................................................................................................ 44
Party Search – JSON Representation Party Search – XML Representation ................................. 48
Search Results—Data Definitions .............................................................................................................. 49
Case Search Results ................................................................................................................................ 49
Party Search Results ............................................................................................................................... 52
Sorting ......................................................................................................................................................... 55
Sortable Case Fields .............................................................................................................................. 55
Sortable Party Fields .............................................................................................................................. 55
Pagination ................................................................................................................................................... 55
Appendix A: Court IDs ................................................................................................................................ 56
Appendix B: Bankruptcy Chapters ............................................................................................................. 61
Appendix C: Civil Nature of Suits ............................................................................................................... 62
Appendix D: Appellate Nature of Suits ...................................................................................................... 65
Appendix E: Search Regions in Production ................................................................................................ 72
Appendix F: Case Types .............................................................................................................................. 76
Appendix G: Response Codes .................................................................................................................... 77
3
...
Case Search
Immediate
Authentication Party Search
PCL API
Search Tools Case Search
Party Search
Batch
Status Query
Download
...
out
System. .printf("New NextGenCSO Key: %s\n", newNextGenCso);
}
}
//-------------------------------------------------------------------------
...
<!-- page 13 -->
Party Search - JSON
Search for a party name with first and last name.
...
out
System. .println(requestResponse.toString());
isr.close();
} else {
return;
}
...
if (responseCode == HttpURLConnection. ) {
out
System. .println("The specified batch job was deleted.\n");
} else {
out
System. .println("No results returned. HTTP Response Code: [" +
responseCode + "].\n");
}
}
catch (IOException e) {
...
Service: /cases/find
Method: POST
URL Sorting and pagination options (see the Sorting and Pagination sections
parameter: below for examples)
Request body: CourtCaseSearchDto
...
Description: Retrieve the status of a batch search job.
Service: /cases/download/status/{reportId}
Method: GET
...
Description: Retrieve the status of the batch search job.
Service: /parties/download/status/{reportId}
Method: GET
URL parameter: reportId is the ID of the report.
Response body: ReportListType
Description: List all batch jobs.
Service: /parties/reports
Method: GET
Response body: ReportListType
Description: Remove an existing batch job.
Service: /parties/reports/{reportId}
Method: DELETE
39
...
jurisdictionType String Jurisdiction type of the case • ap for appellate cases
• bk for bankruptcy cases
• cr for criminal cases
• cv for civil cases
• mdl for Judicial Panel Multidistrict Litigation (JPML)
cases
caseId Integer Sequentially generated number that Integer maximum: 2,147,483,647
identifies the case
caseNumberFull String Case number When all elements are present in the case number, the
...
<!-- page 41 -->
caseTitle String The title by which the case is commonly Text field that is not case-sensitive and accepts
known alphanumeric and special characters.
Maximum length: 254
caseOffice String The divisional office in which the case One alphanumeric character
was filed
caseNumber String The sequence number of the case Five-digit number
caseType List[String] Code that identifies the type of case Text field that accepts letters, numbers, and special
characters.
Maximum length: 6
caseYear String The last two digits of the year in which Two-digit or four-digit year
the case was filed
courtId List[String] The general geographical region or The court ID is the abbreviation of the court location
specific court district combined with the court type (dc or bk).
...
role-and-structure.
dateFiledFrom and Date Filing date of the case, generated during Date in the format yyyy-MM-dd
dateFiledTo case opening
effectiveDateClosedFrom Date Filing date of the most recent docket Date in the format yyyy-MM-dd
and entry that terminated (closed) the case
effectiveDateClosedTo (if a case was closed and reopened,
there could have been multiple
terminations)
BANKRUPTCY CASES ONLY
API Field(s) Type Description Format
federalBankruptcyChapter List[String] Federal bankruptcy chapter under • 7: Chapter 7
which the case is filed • 9: Chapter 9
• 11: Chapter 11
• 13: Chapter 13
• 15: Chapter 15
41
...
{ <caseSearch xmlns="https://pacer.uscourts.gov">
"jurisdictionType": "", <jurisdictionType></jurisdictionType>
"caseId" :"", <caseId></caseId>
"caseNumberFull": "", <caseNumberFull></caseNumberFull>
"caseTitle": "", <caseTitle></caseTitle>
"caseOffice": "", <caseOffice></caseOffice>
"caseNumber": "", <caseNumber></caseNumber>
"caseType": [ <caseType>
"" <element></element>
], </caseType>
"caseYear": "", <caseYear></caseYear>
"courtId": [ <courtId>
"" <element </element>
], </courtId>
"dateFiledFrom": "", <dateFiledFrom></dateFiledFrom>
"dateFiledTo": "", <dateFiledTo></dateFiledTo>
"effectiveDateClosedFrom": "", <effectiveDateClosedFrom></effectiveDateClosedFrom>
"effectiveDateClosedTo":"", <effectiveDateClosedTo></effectiveDateClosedTo>
"federalBankruptcyChapter": [ <federalBankruptcyChapter>
"" <element></element>
], </federalBankruptcyChapter>
"dateDismissedFrom": "", <dateDismissedFrom></dateDismissedFrom>
"dateDismissedTo": "", <dateDismissedTo></dateDismissedTo>
"dateDischargedFrom": "", <dateDischargedFrom></dateDischargedFrom>
"dateDischargedTo": "", <dateDischargedTo></dateDischargedTo>
"natureOfSuit": [ <natureOfSuit>
"" <element></element>
], </natureOfSuit>
"jpmlNumber" : <jpmlNumber></jpmlNumber>
} </caseSearch>
43
...
API Field(s) Type Description Format
reportId String User-supplied identifier that is returned with This field has no effect on the search or the results of
search results the search but is useful for identifying a search.
courtId List[String] The geographical region or specific court See Appendix E for a list of valid regions for each
district environment.
caseId Integer A unique identifier for each case
caseNumberFull String A formatted case number Case numbers may be entered in each of the
following formats:
• yy-nnnnn
• yy-tp-nnnnn
• yy tp nnnnn
...
lastName String The last name of a party to search. This field Alphanumeric value of last name
...
capitalization.
partyType String The court-assigned party type for a party Party type codes are created and assigned by
involved in a case individual courts, and as such, their meanings can vary
from court to court.
role List[String] The court-assigned role for a party to a case Party role codes are created and assigned by individual
...
had been omitted.
exactNameMatch Boolean By default, any party name value provided {
will return any party whose name starts with "lastName": "Smith",
that value. "exactNameMatch": true
}
...
<!-- page 47 -->
caseYearFrom Integer Limit results to those of cases from the year 4-digit integer value maximum
specified and later
caseYearTo Integer Limit results to those of cases from the year 4-digit integer value maximum
specified and earlier
jurisdictionType String The most common jurisdiction types are:
...
ssn String Search for parties with a particular SSN. Must be all-numeric values; may include dashes but
not required
ssn4 String Search for parties whose SSN ends with a When specified, a last name/entity name must also be
specified four digits. specified.
47
...
"partyType": "", <partyRole></partyRole>
"partyRole": "", <partyType></partyType>
"exactNameMatch": , <exactNameMatch></exactNameMatch>
"caseYearFrom": "", <caseYearFrom></caseYearFrom>
...
ALL COURT TYPES
API Field(s) Type Description Format
caseLink String Link to case in the case URL of the case in CM/ECF
...
known alphanumeric and special characters
Maximum length: 254
caseOffice String The divisional office in which the case was One alphanumeric character
filed
caseNumber String The sequence number of the case Five-digit number
caseType String Code that identifies the type of case Text field that accepts letters, numbers, and special
characters
Maximum length: 6
caseYear Short The last two digits of the year in which the Two- or four-digit year
case was filed
courtId List[String] The general geographical region or specific The court ID is the abbreviation of the court location
court district combined with the court type (dc or bk).
Maximum length: 6 characters.
For a complete list of valid court IDs and regions, see
Appendix A. More information about the role and
structure of the U.S. courts can be found here:
...
dateFiledFrom and Date Filing date of the case, generated during Date in the format yyyy-mm-dd
dateFiledTo case opening
effectiveDateClose Date Filing date of the most recent docket entry Date in the format yyyy-mm-dd
dFrom and that terminated (closed) the case (if a case
effectiveDateClose was closed and reopened, there could have
dTo been multiple terminations)
BANKRUPTCY CASES ONLY
API Field(s) Type Description Format
federalBankruptcy List[String] Federal bankruptcy chapter under which • 7: Chapter 7
Chapter the case is filed • 9: Chapter 9
• 11: Chapter 11
• 13: Chapter 13
• 15: Chapter 15
• 304: Chapter 304
...
Appendix B.
dateDismissedFrom Date Date range of bankruptcy case dismissal Date in the format yyyy-MM-dd
and
dateDismissedTo
dateDischargedFrom Date Date range of bankruptcy case discharge Date in the format yyyy-MM-dd
and
dateDischargedTo
CIVIL AND APPELLATE CASES ONLY
API Field(s) Type Description Format
natureOfSuit List[String] Nature of suit for the case Three or four digits. See valid values for civil nature of
...
numberOfElements Integer Number of records returned (NOTE: Not Maximum long value:
applicable for batch report requests) 9,223,372,036,854,775,807
first Boolean Indicates if the current page is the first page True or false
...
<!-- page 53 -->
startTime Date Time when the report generation yyyy-MM-dd'T'HH:mm:ss.SSSZ
started (timezone="US/Central")
endTime Date Time when the report generation ended yyyy-MM-dd'T'HH:mm:ss.SSSZ
(timezone="US/Central")
...
COURT CASE
API Field Type Description Format
caseNumberFull String ID of the court. Case number can See Case Searches – Searchable Fields table
...
caseType List[String] Code identifies type of case List of strings accepts letters, numbers, and special
...
effectiveDateClosedFrom Date Search on date close start date yyyyy-mm-dd
...
jurisdictionType String Court with jurisdiction See Cases Searches – Searchable Fields
...
caseId dateDischarged mdlCourtId mdlTransfereeDistri
ct
caseYear bankrupctyChapter civilDateInitiate mdlLittype
caseNumber dispositionMethod civilDateDisposition mdlStatus
caseOffice jointDispositionMethod civilDateTerminated mdlDateReceived
caseType jointDismissedDate civilStatInitiated mdlDateOrdered
caseTitle jointDischargedDate civilStatDisposition mdlTransferee
dateFiled jointBankruptcyFlag civilStatTerminated
effectiveDateC natureOfSuit civilCtoNumber
losed
