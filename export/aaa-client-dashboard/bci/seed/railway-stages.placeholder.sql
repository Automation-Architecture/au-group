...
--
-- Typical intent: register project slug `bci` so timeline / budget widgets resolve.
--
...
--
-- If your app lazy-inserts on GET /api/projects/bci/stages, you may skip this file.
