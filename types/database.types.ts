...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      au_group_claim_job: {
        Args: { p_job_type: Database["public"]["Enums"]["au_group_job_type"] }
        Returns: {
          bankruptcy_id: string | null
          completed_at: string | null
          created_at: string
      ...
      au_group_is_target_state: {
        Args: { p_state: string; p_states?: string[] }
        Returns: boolean
      }
      ...
      au_group_list_pacer_poll_candidates:
        ...
        | {
            Args: { p_limit?: number; p_states?: string[] }
            Returns: {
              case_number: string
              chapter_type: Database["public"]["Enums"]["bankruptcy_chapter"]
              city: string | null
