-- SYS-01B / SYS-06: bulk upsert PACER docket rows from n8n (PostgREST POST /rest/v1/rpc/au_group_upsert_docket_entries)

create unique index if not exists idx_docket_entries_bankruptcy_docket_number_unique
  on public.docket_entries (bankruptcy_id, docket_number)
...
grant execute on function public.au_group_upsert_docket_entries (uuid, jsonb)
  to service_role;
